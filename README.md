push_swap monitor est un projet qui a pour but de permettre au éléve de 42 d'optenir le plus simplement possible un maximum de statistic sur leur push swap
